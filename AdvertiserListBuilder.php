...
class AdvertiserListBuilder extends EntityListBuilder {
  ...
  public function render() {
    $build['description'] = [
      '#markup' => $this->t('Advertiser implements a Advertiser model. These advertiser are fieldable entities. You can manage the fields on the <a href="@adminlink">Contacts admin page</a>.', [
        '@adminlink' => $this->urlGenerator->generateFromRoute('advertiser.advertiser_settings'),
      ]),
    ];
